...
import org.bboss.elasticsearchtest.springboot.ServiceApiUtil;
...
public class DocumentCRUD {
	...
	public DocumentCRUD(ServiceApiUtil serviceApiUtil){
		this.serviceApiUtil = serviceApiUtil;
	}
	public void testCreateIndice(){
		//创建加载配置文件的客户端工具，单实例多线程安全
		ClientInterface clientUtil = serviceApiUtil.restDemoConfigClient();
		try {
...
//				System.out.println(r);
	...
	public void testAddAndUpdateDocument() throws ParseException {
		...
		ClientInterface clientUtil = serviceApiUtil.restClient();
